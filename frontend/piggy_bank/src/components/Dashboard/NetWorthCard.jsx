            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-2xl font-bold text-gray-800 mt-1">
                        {data.netWorth.toLocaleString()} {data.currency}
                    </p>
                ...
                <div className="text-right">
                    ...
                    <p className="text-md font-semibold text-emerald-700">{data.totalAssets.toLocaleString()} {data.currency}</p>
                    <p className="text-xs text-rose-500 mt-1">Liabilities</p>
                    <p className="text-md font-semibold text-rose-600">{data.totalLiabilities.toLocaleString()} {data.currency}</p>
                </div>
            </div>
        </div>
    )
